...
(let ((yoshi-0 "#111414")
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-builtin-face ((t (:foreground ,yoshi-7))))
   ...
   `(highlight ((t (:background ,yoshi-2))))
   ...
   `(company-preview-common ((t (:foreground ,(color-darken-name yoshi-7 30) :inherit unspecified :weight bold))))
   ...
   `(company-tooltip-common ((t (:foreground ,yoshi-7))))
   ...
   `(eshell-ls-symlink ((t (:foreground ,yoshi-7 :weight unspecified))))
   ...
   `(gnus-cite-6 ((t (:foreground ,yoshi-7))))
   `(gnus-cite-7 ((t (:foreground ,fgblue))))
   `(gnus-cite-8 ((t (:foreground ,fgpurple))))
   `(gnus-cite-9 ((t (:foreground ,fgmagenta))))
   `(gnus-group-mail-3 ((t (:foreground ,yoshi-7 :weight bold))))
   `(gnus-group-mail-3-empty ((t (:foreground ,yoshi-7))))
   ...
   `(gnus-summary-normal-ancient ((t (:foreground ,yoshi-7))))
   ...
   `(helm-buffer-not-saved ((t (:foreground ,yoshi-7))))
   ...
   `(helm-ff-symlink ((t (:foreground ,yoshi-7))))
   ...
   ;;; Highlight numbers
   `(highlight-numbers-number ((t (:foreground ,yoshi-7 :inherit unspecified))))
   ...
   `(hydra-face-teal ((t (:foreground ,yoshi-7 :weight bold))))
   ...
   `(magit-log-head-label-default ((t (:foreground ,yoshi-6 :background ,yoshi-7 :box (:color ,yoshi-7 :line-width 2 :style nil)))))
   ...
   `(markdown-header-face-2 ((t (:foreground ,yoshi-7 :inherit unspecified))))
   ...
   `(org-agenda-date ((t (:foreground ,yoshi-7))))
   `(org-agenda-date-today ((t (:foreground ,yoshi-7 :slant italic))))
   `(org-agenda-date-weekend ((t (:foreground ,yoshi-7))))
   ...
   `(org-checkbox-statistics-done ((t (:foreground ,yoshi-7))))
   `(org-checkbox-statistics-todo ((t (:foreground ,yoshi-7))))
   ...
   `(org-level-2 ((t (:foreground ,yoshi-7 :weight bold :height 1.1))))
   ...
   `(rainbow-delimiters-depth-6-face ((t (:foreground ,yoshi-7))))
   ...
   `(term-color-cyan ((t (:background ,(color-darken-name yoshi-7 30) :foreground ,yoshi-7))))
   ...
   ;;; Whitespace mode
   `(whitespace-empty ((t (:background ,(color-darken-name yoshi-7 30) :foreground ,yoshi-6))))
   ...
   `(rpm-spec-var-face ((t (:foreground ,yoshi-7))))
  ...
  (custom-theme-set-variables
   ...
   `(ansi-color-names-vector [,yoshi-1 ,fgred ,fggreen ,fgyellow
                                       ,fgblue ,fgmagenta ,yoshi-7 ,yoshi-4])
