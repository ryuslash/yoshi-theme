...
(custom-theme-set-faces
 ...
 '(flycheck-error-face ((t (:foreground nil :underline (:color "#ff756e" :style wave)))))
 ...
 '(highlight-80+ ((t (:underline (:color "#ff756e" :style wave) :background nil))))
 ...
 '(markdown-header-face-5 ((t (:foreground "#ff756e"))))
 ...
 '(org-level-5 ((t (:foreground "#ff756e"))))
 ...
 '(org-scheduled-previously ((t (:foreground "#ff756e" :bold t))))
